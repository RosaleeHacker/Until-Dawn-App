...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.clues', {
    ...
    views: {
      'tab-clues': {
        templateUrl: 'templates/tab-clues.html',
        controller: 'CluesCtrl'
      }
    }
  })

  .state('tab.totem-detail', {
    url: '/clues/:totemId',
    views: {
      'tab-clues': {
        templateUrl: 'templates/totem-detail.html',
        controller: 'TotemDetailCtrl'
      }
    }
  })
  ...
  .state('tab.butterfly', {
    ...
    views: {
      'tab-butterfly': {
        templateUrl: 'templates/tab-butterfly.html',
        controller: 'ButterflyCtrl'
      }
    }
  });
