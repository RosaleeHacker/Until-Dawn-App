...
.factory('Totems', function() {
  ...
  var totems = [
    { id: 1, 
      ...
      totem1: 1, totem1Img: 'img/Totems/DeathTotem1.jpg', totem1Chapter: 'Prolouge', totem1Location: 'On ground while following Hannah', totem1Found: 'Beth', totem1Contents: 'Beth and Hannah falling to their deaths',
      totem2: 2, totem2Img: 'img/Totems/DeathTotem2.jpg', totem2Chapter: 'Chapter 5', totem2Location: 'Near benches by cable car station', totem2Found: 'Matt', totem2Contents: 'Matt falling to his death from cliff',
      totem3: 3, totem3Img: 'img/Totems/DeathTotem3.jpg', totem3Chapter: 'Chapter 5,9', totem3Location: 'Staircase in chapel, back left corner', totem3Found: 'Mike', totem3Contents: 'Mike lighting a fire upon himself',
      totem4: 4, totem4Img: 'img/Totems/DeathTotem4.jpg', totem4Chapter: 'Chapter 4,8', totem4Location: 'Past clown scare, next to pigs head', totem4Found: 'Chris', totem4Contents: 'Chris getting hanged by an attacker',
      totem5: 5, totem5Img: 'img/Totems/DeathTotem5.jpg', totem5Chapter: 'Chapter 7', totem5Location: 'Past flying cart, in back of collapsed tunnel', totem5Found: 'Emily', totem5Contents: 'Emily getting shot in eye',
      totem6: 6, totem6Img: 'img/Totems/DeathTotem6.jpg', totem6Chapter: 'Chapter 9', totem6Location: 'Past rock wall, straight ahead on walkway', totem6Found: 'Sam', totem6Contents: 'Sam being impaled by a Wendigo'
    },
    { id: 2, 
      type: 'Danger',
      ...
      totem1: 1, totem1Img: 'img/Totems/DangerTotem1.jpg', totem1Chapter: 'Chapter 2', totem1Location: 'Near generator', totem1Found: 'Mike', totem1Contents: 'The Psycho punching Ashley unconscious',
      totem2: 2, totem2Img: 'img/Totems/DangerTotem2.jpg', totem2Chapter: 'Chapter 3', totem2Location: 'In forest, left of frozen truck', totem2Found: 'Mike', totem2Contents: 'A horde of deer',
      totem3: 3, totem3Img: 'img/Totems/DangerTotem3.jpg', totem3Chapter: 'Chapter 7', totem3Location: 'Restore power to lift, near wooden doorway', totem3Found: 'Emily', totem3Contents: 'A lanky arm trying to grab Mike',
      totem4: 4, totem4Img: 'img/Totems/DangerTotem4.jpg', totem4Chapter: 'Chapter 9', totem4Location: 'In sanatorium chapel, to the left in a room in the northwest corner', totem4Found: 'Mike', totem4Contents: 'Mike being attacked by a Wendigo',
      totem5: 5, totem5Img: 'img/Totems/DangerTotem5.jpg', totem5Chapter: 'Chapter 9', totem5Location: 'In tunnels, in left alcove', totem5Found: 'Ashley', totem5Contents: 'Josh turning into a Wendigo',
      totem6: 6, totem6Img: 'img/Totems/DangerTotem6.jpg', totem6Chapter: 'Chapter 10', totem6Location: 'After leaving caves, keep right on split path', totem6Found: 'Sam', totem6Contents: 'A Wendigo leaping inside the cabin, chasing survivors' 
    },
    { id: 3, 
      type: 'Loss',
      info: 'Loss foretells a possible death of another character',
      quote: 'Brown butterflies foretold of tragedies affecting friends',
      totem1: 1, totem1Img: 'img/Totems/LossTotem1.jpg', totem1Chapter: 'Chapter 2', totem1Location: 'Straight ahead upon entering the garage', totem1Found: 'Chris', totem1Contents: 'Emily being killed in a burning explosion',
      totem2: 2, totem2Img: 'img/Totems/LossTotem2.jpg', totem2Chapter: 'Chapter 2', totem2Location: 'Upon leaving mine, stay left, near fallen tree', totem2Found: 'Mike', totem2Contents: 'Jess\'s body dropping down elevator shaft with her jaw ripped off',
      totem3: 3, totem3Img: 'img/Totems/LossTotem3.jpg', totem3Chapter: 'Chapter 4,8', totem3Location: 'Go right/back of the shed', totem3Found: 'Chris', totem3Contents: 'Ashleys head decapitated falling to the floor',
      totem4: 4, totem4Img: 'img/Totems/LossTotem4.jpg', totem4Chapter: 'Chapter 5', totem4Location: 'In sanatorium chapel, to the left in a room in the northwest corner', totem4Found: 'Mike', totem4Contents: 'Matts face getting bashed in',
      totem5: 5, totem5Img: 'img/Totems/LossTotem5.jpg', totem5Chapter: 'Chapter 9', totem5Location: 'In tunnels, in left alcove', totem5Found: 'Ashley or Chris', totem5Contents: 'Joshs head being crushed by a Wendigo',
      totem6: 6, totem6Img: 'img/Totems/LossTotem6.jpg', totem6Chapter: 'Chapter 10', totem6Location: 'After leaving caves, keep right on split path', totem6Found: 'Jess or Matt', totem6Contents: 'Mike being killed in a burning explosion'  
    },
    { id: 4, 
      type: 'Guidance',
      ...
      totem1: 1, totem1Img: 'img/Totems/GuidanceTotem1.jpg', totem1Chapter: 'Chapter 1', totem1Location: 'On the ground as Sam is walking towards the cabin', totem1Found: 'Sam', totem1Contents: 'A bird landing on a rock between Mike and Jess, then flying away',
      totem2: 2, totem2Img: 'img/Totems/GuidanceTotem2.jpg', totem2Chapter: 'Chapter 2', totem2Location: 'Walk towards camera when playing as Chris, on ground next to Matt', totem2Found: 'Chris', totem1Contents: 'Someone\'s fingers getting caught in a bear trap',
      totem3: 3, totem3Img: 'img/Totems/GuidanceTotem3.jpg', totem3Chapter: 'Chapter 3', totem3Location: 'On Ground near tree after Jess scares Mike', totem3Found: 'Mike', totem3Contents: 'Sam lifting herself onto a stone wall next to a water wheel',
      totem4: 4, totem4Img: 'img/Totems/GuidanceTotem4.jpg', totem4Chapter: 'Chapter 4', totem4Location: 'At base of staircase in abandoned mine', totem4Found: 'Mike', totem4Contents: 'Mike petting a wolf',
      totem5: 5, totem5Img: 'img/Totems/GuidanceTotem5.jpg', totem5Chapter: 'Chapter 5', totem5Location: 'Around edge of cable car station', totem5Found: 'Emily', totem5Contents: 'Emily handing a flare gun to Matt',
      totem6: 6, totem6Img: 'img/Totems/GuidanceTotem6.jpg', totem6Chapter: 'Chapter 6', totem6Location: 'Infront of fire tower, near bench', totem6Found: 'Emily', totem6Contents: 'Chris putting a pistol onto a table'
    },
    { id: 5, 
      type: 'Fortune',
      ...
      totem1: 1, totem1Img: 'img/Totems/FortuneTotem1.jpg', totem1Chapter: 'Chapter 2', totem1Location: 'In mines, go straight at fork, by some rubble', totem1Found: 'Mike', totem1Contents: 'Jess waking up, badly beaten on an elevator shaft',
      totem2: 2, totem2Img: 'img/Totems/FortuneTotem2.jpg', totem2Chapter: 'Chapter 5', totem2Location: 'In front of main gate in Sanatorium courtyard', totem2Found: 'Mike', totem2Contents: 'Matt backing away from a banging door',
      totem3: 3, totem3Img: 'img/Totems/FortuneTotem3.jpg', totem3Chapter: 'Chapter 5', totem3Location: 'At the fork near the cliff, near a small cluster of trees', totem3Found: 'Matt', totem3Contents: 'Ashley opening the main cabin door, letting Chris in',
      totem4: 4, totem4Img: 'img/Totems/FortuneTotem4.jpg', totem4Chapter: 'Chapter 8', totem4Location: 'In Mines, look for wooden structures on the right', totem4Found: 'Emily', totem4Contents: 'Mike about to shoot, then turning away',
      totem5: 5, totem5Img: 'img/Totems/FortuneTotem5.jpg', totem5Chapter: 'Chapter 10', totem5Location: 'In mines, to the right right before entering the water', totem5Found: 'Sam', totem5Contents: 'Characters standing up and looking outside of the burning cabin',
      totem6: 6, totem6Img: 'img/Totems/FortuneTotem6.jpg', totem6Chapter: 'Chapter 10', totem6Location: 'When Josh, turn left at the fork when leaving the area', totem6Found: 'Josh', totem6Contents: 'A Wendigo inching closer to Sam as she stands still'
    }
  ];
